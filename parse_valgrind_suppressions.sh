...
#===============================================================================
#     File: parse_valgrind_suppressions.sh
#  Created: 07/15/2017, 22:41
#   Author: Unknown
#
#  Description: Parse valgrind suppressions to make suppression file. 
#       Found here: <https://wiki.wxwidgets.org/Parse_valgrind_suppressions.sh>
#
#===============================================================================
#### #! /usr/bin/awk -f
